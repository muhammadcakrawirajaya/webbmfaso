...
<html lang="en">
  <head>
    <title>Input Text - Telescout</title>
        ...
        <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6">
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
              ...
              <div class="mt-5">
                <label class="block">
                  <input class="form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Username" type="text">
                </label>
              </div>
            </div>
            ...
            <div class="max-w-xl">
              ...
              <div class="mt-5">
                <label class="block">
                  ...
                  <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Username" type="text">
                </label>
              </div>
            </div>
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
              ...
              <div class="mt-5">
                ...
                <span class="text-tiny+ text-slate-400 dark:text-navy-300">This is a help text</span>
              </div>
            </div>
  ...
  &lt;label class=&quot;block&quot;&gt;&#13;&#10;    &lt;input&#13;&#10;      class=&quot;form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent&quot;&#13;&#10;      placeholder=&quot;Username&quot;&#13;&#10;      type=&quot;text&quot;&#13;&#10;    /&gt;&#13;&#10;  &lt;/label&gt;&#13;&#10;  &lt;span class=&quot;text-tiny+ text-slate-400 dark:text-navy-300&quot;&#13;&#10;    &gt;This is a help text&lt;/span&#13;&#10;  &gt;</code>
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
              ...
              <div class="mt-5">
                <label class="block">
                  <input class="form-input w-full rounded-full border border-slate-300 bg-transparent px-4 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Username" type="text">
                </label>
              </div>
            </div>
  ...
  &lt;label class=&quot;block&quot;&gt;&#13;&#10;    &lt;input&#13;&#10;      class=&quot;form-input w-full rounded-full border border-slate-300 bg-transparent px-4 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent&quot;&#13;&#10;      placeholder=&quot;Username&quot;&#13;&#10;      type=&quot;text&quot;&#13;&#10;    /&gt;&#13;&#10;  &lt;/label&gt;&#13;&#10;</code>
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
              ...
              <div class="mt-5">
                <label class="block">
                  <input class="form-input w-full rounded-lg bg-slate-150 px-3 py-2 ring-primary/50 placeholder:text-slate-400 hover:bg-slate-200 focus:ring dark:bg-navy-900/90 dark:ring-accent/50 dark:placeholder:text-navy-300 dark:hover:bg-navy-900 dark:focus:bg-navy-900" placeholder="Username" type="text">
                </label>
              </div>
            </div>
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
              ...
              <div class="mt-5 space-y-4">
                <label class="block">
                  <input class="form-input h-8 w-full rounded-full border border-slate-300 bg-transparent px-4 py-2 text-xs+ placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Username" type="text">
                </label>
                <label class="block">
                  <input class="form-input w-full rounded-full border border-slate-300 bg-transparent px-4 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Username" type="text">
                </label>
                <label class="block">
                  <input class="form-input h-12 w-full rounded-full border border-slate-300 bg-transparent px-4 py-2 text-base placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Username" type="text">
                </label>
              </div>
            </div>
  ...
  &lt;label class=&quot;block&quot;&gt;&#13;&#10;    &lt;input&#13;&#10;      class=&quot;form-input h-8 w-full rounded-full border border-slate-300 bg-transparent px-4 py-2 text-xs+ placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent&quot;&#13;&#10;      placeholder=&quot;Username&quot;&#13;&#10;      type=&quot;text&quot;&#13;&#10;    /&gt;&#13;&#10;  &lt;/label&gt;&#13;&#10;  &lt;label class=&quot;block&quot;&gt;&#13;&#10;    &lt;input&#13;&#10;      class=&quot;form-input w-full rounded-full border border-slate-300 bg-transparent px-4 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent&quot;&#13;&#10;      placeholder=&quot;Username&quot;&#13;&#10;      type=&quot;text&quot;&#13;&#10;    /&gt;&#13;&#10;  &lt;/label&gt;&#13;&#10;  &lt;label class=&quot;block&quot;&gt;&#13;&#10;    &lt;input&#13;&#10;      class=&quot;form-input h-12 w-full rounded-full border border-slate-300 bg-transparent px-4 py-2 text-base placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent&quot;&#13;&#10;      placeholder=&quot;Username&quot;&#13;&#10;      type=&quot;text&quot;&#13;&#10;    /&gt;&#13;&#10;  &lt;/label&gt;&#13;&#10;</code>
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
              ...
              <div class="mt-5">
                <label class="block">
                  <input class="form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Choose browser" type="text" list="browsers">
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
              ...
              <div class="mt-5 space-y-4">
                <div>
                  <label class="block">
                    <input class="form-input w-full rounded-lg border border-success bg-transparent px-3 py-2 placeholder:text-slate-400/70" placeholder="Username" type="text" value="Some Value">
                  </label>
                  <span class="text-tiny+ text-success">Username is valid</span>
                </div>
                <div>
                  <label class="block">
                    <input class="form-input w-full rounded-lg border border-error bg-transparent px-3 py-2 placeholder:text-slate-400/70" placeholder="Username" type="text" value="Some Value">
                  </label>
                  <span class="text-tiny+ text-error">Username is invalid</span>
                </div>
              </div>
            </div>
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
              ...
              <div x-data="{debounceText:''}" class="mt-5">
                <label class="block">
                  <input class="form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Username" type="text" x-model.debounce="debounceText">
                </label>
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-xl">
              ...
              <div x-data="{lazyText:''}" class="mt-5">
                <label class="block">
                  <input class="form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Username" type="text" x-model.lazy="lazyText">
                </label>
