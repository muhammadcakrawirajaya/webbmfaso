              ...
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:gap-6">
                ...
                <div class="grid grid-cols-2 gap-4 sm:gap-5 lg:gap-6">
                  <div>
                    ...
                    <button class="btn mt-3 w-full border border-white/10 bg-white/20 text-white hover:bg-white/30 focus:bg-white/30">
                      Receive
                    </button>
                  </div>
                  <div>
              ...
              <div class="scrollbar-sm flex space-x-4 overflow-x-auto overflow-y-hidden px-4 pb-2 sm:px-5">
                <div class="flex w-72 shrink-0 flex-col">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/logos/bitcoin.svg')}}" alt="flag">
                    <div>
                      <span>Bitcoin</span>
                ...
                <div class="flex w-72 shrink-0 flex-col">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/logos/ethereum.svg')}}" alt="flag">
                    <div>
                      <span>Ethereum</span>
                      <span class="text-xs uppercase text-slate-400 dark:text-navy-300">
                        ETH
                  ...
                  <div class="mt-2.5 flex justify-between rounded-lg bg-slate-50 py-3 pr-3 dark:bg-navy-600">
                    <div class="ax-transparent-gridline">
                      <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.cryptoWatchlist2); $el._x_chart.render() });"></div>
                    </div>
                    <div class="flex w-36 flex-col items-center rounded-lg bg-slate-100 py-2 font-inter dark:bg-navy-500">
                      <p class="text-xl font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                        $7,668.56
                ...
                <div class="flex w-72 shrink-0 flex-col">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/logos/solana.svg')}}" alt="flag">
                    <div>
                      <span>Solana</span>
                      <span class="text-xs uppercase text-slate-400 dark:text-navy-300">
                        SOl
                ...
                <div class="flex w-72 shrink-0 flex-col">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/logos/litecoin.svg')}}" alt="flag">
                    <div>
                      <span>Litecoin</span>
                      <span class="text-xs uppercase text-slate-400 dark:text-navy-300">
                        LTC
                  ...
                  <div class="mt-2.5 flex justify-between rounded-lg bg-slate-50 py-3 pr-3 dark:bg-navy-600">
                    <div class="ax-transparent-gridline">
                      <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.cryptoWatchlist4); $el._x_chart.render() });"></div>
                    </div>
                    <div class="flex w-36 flex-col items-center rounded-lg bg-slate-100 py-2 font-inter dark:bg-navy-500">
                      <p class="text-xl font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                        $487.76
                  ...
                  <table class="is-hoverable w-full text-left">
                    ...
                    <tbody>
                      <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                          <div class="flex items-center space-x-4">
                            <div class="flex size-9 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-primary dark:bg-accent dark:text-white">
                      ...
                      <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                          <div class="flex items-center space-x-4">
                            <div class="flex size-9 shrink-0 items-center justify-center rounded-lg bg-info/10 text-info dark:bg-info dark:text-white">
                              <svg xmlns="http://www.w3.org/2000/svg" class="size-5.5" fill="none" viewbox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                      ...
                      <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                          <div class="flex items-center space-x-4">
                            <div class="flex size-9 shrink-0 items-center justify-center rounded-lg bg-warning/10 text-warning dark:bg-warning dark:text-white">
          ...
          <div class="col-span-12 grid grid-cols-1 gap-4 sm:gap-5 lg:col-span-4 lg:gap-6">
              ...
              <div class="scrollbar-sm flex space-x-3 overflow-x-auto px-4 pb-3 sm:px-5">
                <div class="w-48 shrink-0 rounded-lg bg-gradient-to-br from-amber-400 to-orange-600 p-[3px]">
                  <div class="rounded-lg bg-white p-3 dark:bg-navy-700">
                    <div class="flex items-center justify-between">
                      <p>Bitcoin</p>
                      <img src="{{asset('assets/images/logos/bitcoin.svg')}}" class="size-6" alt="logo">
                    </div>
                ...
                <div class="w-48 shrink-0 rounded-lg bg-gradient-to-br from-purple-500 to-indigo-600 p-[3px]">
                  <div class="rounded-lg bg-white p-3 dark:bg-navy-700">
                    <div class="flex items-center justify-between">
                      <p>Litecoin</p>
                      <img src="{{asset('assets/images/logos/litecoin.svg')}}" class="size-6" alt="logo">
                    </div>
                ...
                <div class="w-48 shrink-0 rounded-lg bg-gradient-to-br from-info to-info-focus p-[3px]">
                  <div class="rounded-lg bg-white p-3 dark:bg-navy-700">
                    <div class="flex items-center justify-between">
                      <p>Ethereum</p>
                      <img src="{{asset('assets/images/logos/ethereum.svg')}}" class="size-6" alt="logo">
                    </div>
              ...
              <div class="mt-1 px-4 sm:px-5">
                ...
                <div class="mt-3 flex space-x-2">
                  <div class="avatar size-8 hover:z-10">
                    <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{asset('assets/images/avatar/avatar-16.jpg')}}" alt="avatar">
                  </div>
                  ...
                  <div class="avatar size-8 hover:z-10">
                    <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{asset('assets/images/avatar/avatar-20.jpg')}}" alt="avatar">
                  </div>

                  <div class="avatar size-8 hover:z-10">
                    <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{asset('assets/images/avatar/avatar-19.jpg')}}" alt="avatar">
                  </div>
                </div>
            ...
            <div class="card">
              ...
              <div class="ax-transparent-gridline pr-2">
                <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.cryptoTransactions); $el._x_chart.render() });"></div>
              </div>
            </div>
          </div>
        </div>
