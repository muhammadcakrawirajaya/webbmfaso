...
<html lang="en">
  <head>
    <title>Crypto 2 - Telescout</title>
        ...
        <div class="mt-4 grid grid-cols-12 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            ...
            <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6">
              <div :class="$store.breakpoints.smAndUp && 'card px-5 pb-3'">
                <div class="flex items-center justify-between sm:py-3">
                  ...
                  <div class="flex space-x-4 font-inter text-slate-700 dark:text-navy-100" x-data="{activeTab:'12hr'}">
                    <div class="hidden w-full justify-between space-x-4 font-inter text-slate-700 dark:text-navy-100 sm:flex">
                      <button @click="activeTab = '1wk'" class="font-medium tracking-wide" :class="activeTab === '1wk' && 'text-primary dark:text-accent-light' ">
                        1 Wk
                      </button>

                      <button @click="activeTab = '5days'" class="font-medium tracking-wide" :class="activeTab === '5days' && 'text-primary dark:text-accent-light' ">
                        5 days
                      </button>

                      <button @click="activeTab = '1days'" class="font-medium tracking-wide" :class="activeTab === '1days' && 'text-primary dark:text-accent-light' ">
                        1 days
                      </button>

                      <button @click="activeTab = '12hr'" class="font-medium tracking-wide" :class="activeTab === '12hr' && 'text-primary dark:text-accent-light' ">
                        12 Hr
                      </button>

                      <button @click="activeTab = '1hr'" class="font-medium tracking-wide" :class="activeTab === '1hr' && 'text-primary dark:text-accent-light' ">
                        1 Hr
                      </button>
                    </div>

                    <div x-data="usePopper({placement:'bottom-end',offset:4})" @click.outside="isShowPopper && (isShowPopper = false)" class="inline-flex">
                      <button x-ref="popperRef" @click="isShowPopper = !isShowPopper" class="btn size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 sm:-mr-1.5">
                ...
                <div>
                  <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.cryptoCandlestick); $el._x_chart.render() });"></div>
                </div>
              </div>
              <div class="grid grid-cols-2 gap-4 sm:order-first sm:grid-cols-4 sm:gap-5 lg:gap-6">
                ...
                <div class="rounded-lg border border-slate-150 p-3 dark:border-navy-700">
                  <div class="flex justify-between">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5 shrink-0 text-success" viewbox="0 0 20 20" fill="currentColor">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div class="flex items-center justify-between space-x-2 rounded-lg border border-slate-200 p-3 dark:border-navy-600">
                    <div class="flex items-center space-x-3">
                      <div class="flex size-10 shrink-0 items-center justify-center rounded-lg bg-success">
                    ...
                    <input checked="" class="form-switch h-5 w-10 rounded-lg bg-slate-300 before:rounded-md before:bg-slate-50 checked:bg-primary checked:before:bg-white dark:bg-navy-900 dark:before:bg-navy-300 dark:checked:bg-accent dark:checked:before:bg-white" type="checkbox">
                  </div>
                  <div class="flex items-center justify-between space-x-2 rounded-lg border border-slate-200 p-3 dark:border-navy-600">
                    <div class="flex items-center space-x-3">
                      <div class="flex size-10 shrink-0 items-center justify-center rounded-lg bg-success">
                  ...
                  <div class="flex items-center justify-between space-x-2 rounded-lg border border-slate-200 p-3 dark:border-navy-600">
                    <div class="flex items-center space-x-3">
                      <div class="flex size-10 shrink-0 items-center justify-center rounded-lg bg-warning">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-6 text-white" fill="none" viewbox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                          <path stroke-linecap="round" stroke-linejoin="round" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z"></path>
                        </svg>
                      </div>
                    ...
                    <input class="form-switch h-5 w-10 rounded-lg bg-slate-300 before:rounded-md before:bg-slate-50 checked:bg-primary checked:before:bg-white dark:bg-navy-900 dark:before:bg-navy-300 dark:checked:bg-accent dark:checked:before:bg-white" type="checkbox">
                  </div>
                  <div class="flex items-center justify-between space-x-2 rounded-lg border border-slate-200 p-3 dark:border-navy-600">
                    <div class="flex items-center space-x-3">
                      <div class="flex size-10 shrink-0 items-center justify-center rounded-lg bg-slate-300 text-slate-700 dark:bg-navy-450 dark:text-navy-100">
          ...
          <div class="col-span-12 lg:col-span-4">
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-4 sm:gap-5 lg:grid-cols-2 lg:gap-6">
              <div class="rounded-lg bg-primary p-4 transition-shadow duration-300 hover:shadow-lg hover:shadow-primary/50 dark:bg-accent dark:shadow-accent/50 dark:hover:shadow-accent/50">
              ...
              <div class="rounded-lg bg-warning p-4 transition-shadow duration-300 hover:shadow-lg hover:shadow-warning/50">
                <div class="flex size-10 items-center justify-center rounded-lg bg-white/90">
              ...
              <div class="rounded-lg bg-info p-4 transition-shadow duration-300 hover:shadow-lg hover:shadow-info/50">
                <div class="flex size-10 items-center justify-center rounded-lg bg-white/90">
              ...
              <div class="rounded-lg bg-secondary p-4 transition-shadow duration-300 hover:shadow-lg hover:shadow-secondary/50">
                <div class="flex size-10 items-center justify-center rounded-lg bg-white/90">
            ...
            <div class="card mt-4 px-4 pb-4 sm:mt-5 sm:px-5 lg:mt-6">
              ...
              <div x-data="{activeTab:'tabReceive'}" class="tabs flex flex-col">
                <div class="is-scrollbar-hidden overflow-x-auto rounded-lg bg-slate-150 text-slate-600 dark:bg-navy-800 dark:text-navy-200">
                  <div class="tabs-list flex px-1.5 py-1">
                    <button @click="activeTab = 'tabReceive'" :class="activeTab === 'tabReceive' ? 'bg-white shadow dark:bg-navy-500 dark:text-navy-100' : 'hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100'" class="btn flex-1 space-x-2 px-3 py-2 font-medium">
                    ...
                    <button @click="activeTab = 'tabSend'" :class="activeTab === 'tabSend' ? 'bg-white shadow dark:bg-navy-500 dark:text-navy-100' : 'hover:text-slate-800 focus:text-slate-800 dark:hover:text-navy-100 dark:focus:text-navy-100'" class="btn flex-1 space-x-2 px-3 py-2 font-medium">
                      <svg xmlns="http://www.w3.org/2000/svg" class="size-4.5" viewbox="0 0 20 20" fill="currentColor">
              ...
              <div class="relative">
                <div class="pt-4">
                  ...
                  <div class="mt-1 flex justify-between space-x-2 rounded-2xl bg-slate-150 p-1.5 dark:bg-navy-800">
                    ...
                    <input class="form-input w-full bg-transparent px-2 text-right placeholder:text-slate-400/70" placeholder="Amount" type="text">
                  </div>
                </div>
                <div class="pt-4">
                ...
                <div class="absolute right-0 top-1/2 mt-1">
                  <button class="btn mask is-hexagon size-7 bg-primary p-0 font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
