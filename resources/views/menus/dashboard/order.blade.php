            ...
            <div class="scrollbar-sm flex space-x-3 overflow-x-auto px-4 pb-3 sm:px-5">
              <div class="w-56 shrink-0 rounded-xl bg-slate-50 p-4 dark:bg-navy-600">
                <div class="flex flex-col items-center space-y-3 text-center">
                  <div class="size-16 rounded-full bg-gradient-to-r from-sky-400 to-blue-600 p-0.5">
                    <img class="h-full w-full rounded-full border-2 border-white object-cover object-center dark:border-navy-700" src="{{asset('assets/images/avatar/avatar-20.jpg')}}" alt="image">
                  </div>
                  <div>
                ...
                <div class="mt-5 flex justify-center space-x-2">
                  <button class="btn size-8 rounded-full bg-primary/10 p-0 text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-accent-light/10 dark:text-accent-light dark:hover:bg-accent-light/20 dark:focus:bg-accent-light/20 dark:active:bg-accent-light/25">
              ...
              <div class="w-56 shrink-0 rounded-xl bg-slate-50 p-4 dark:bg-navy-600">
                <div class="flex flex-col items-center space-y-3 text-center">
                  <div class="size-16 rounded-full bg-gradient-to-r from-sky-400 to-blue-600 p-0.5">
                    <img class="h-full w-full rounded-full border-2 border-white object-cover object-center dark:border-navy-700" src="{{asset('assets/images/avatar/avatar-5.jpg')}}" alt="image">
                  </div>
                  <div>
                    <p class="text-base font-medium text-slate-700 dark:text-navy-100">
                      Konnor Guzman
                ...
                <div class="mt-5">
                  ...
                  <div class="ax-transparent-gridline">
                    <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.topSeller2); $el._x_chart.render() });"></div>
                  </div>
                </div>
                <div class="mt-5 flex justify-center space-x-2">
                  <button class="btn size-8 rounded-full bg-primary/10 p-0 text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-accent-light/10 dark:text-accent-light dark:hover:bg-accent-light/20 dark:focus:bg-accent-light/20 dark:active:bg-accent-light/25">
              ...
              <div class="w-56 shrink-0 rounded-xl bg-slate-50 p-4 dark:bg-navy-600">
                <div class="flex flex-col items-center space-y-3 text-center">
                  <div class="size-16 rounded-full bg-gradient-to-r from-sky-400 to-blue-600 p-0.5">
                    <img class="h-full w-full rounded-full border-2 border-white object-cover object-center dark:border-navy-700" src="{{asset('assets/images/avatar/avatar-11.jpg')}}" alt="image">
                  </div>
                  <div>
                    <p class="text-base font-medium text-slate-700 dark:text-navy-100">
                      Katrina West
                ...
                <div class="mt-5">
                  ...
                  <div class="ax-transparent-gridline">
                    <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.topSeller3); $el._x_chart.render() });"></div>
                  </div>
                </div>
                <div class="mt-5 flex justify-center space-x-2">
                  <button class="btn size-8 rounded-full bg-primary/10 p-0 text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-accent-light/10 dark:text-accent-light dark:hover:bg-accent-light/20 dark:focus:bg-accent-light/20 dark:active:bg-accent-light/25">
              ...
              <div class="w-56 shrink-0 rounded-xl bg-slate-50 p-4 dark:bg-navy-600">
                <div class="flex flex-col items-center space-y-3 text-center">
                  <div class="size-16 rounded-full bg-gradient-to-r from-sky-400 to-blue-600 p-0.5">
                    <img class="h-full w-full rounded-full border-2 border-white object-cover object-center dark:border-navy-700" src="{{asset('assets/images/avatar/avatar-17.jpg')}}" alt="image">
                  </div>
                  <div>
                    <p class="text-base font-medium text-slate-700 dark:text-navy-100">
                      Henry Curtis
                ...
                <div class="mt-5">
                  ...
                  <div class="ax-transparent-gridline">
                    <div x-init="$nextTick(() => { $el._x_chart = new ApexCharts($el,pages.charts.topSeller4); $el._x_chart.render() });"></div>
                  </div>
                </div>
                <div class="mt-5 flex justify-center space-x-2">
                  <button class="btn size-8 rounded-full bg-primary/10 p-0 text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-accent-light/10 dark:text-accent-light dark:hover:bg-accent-light/20 dark:focus:bg-accent-light/20 dark:active:bg-accent-light/25">
          ...
          <div class="col-span-12 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:col-span-7 lg:gap-6 xl:col-span-6">
              ...
              <div class="mt-5 space-y-4">
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/logos/instagram-round.svg')}}" alt="flag">
                    <p>Instagram</p>
                  </div>
                  <div class="flex items-center space-x-2">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/logos/facebook-round.svg')}}" alt="flag">
                    <p>Facebook</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/logos/youtube-round.svg')}}" alt="flag">
                    <p>Youtube</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/logos/pinterest-round.svg')}}" alt="flag">
                    <p>Pinterest</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/logos/discord-round.svg')}}" alt="flag">
                    <p>Discord</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/logos/tik_tok-round.svg')}}" alt="flag">
                    <p>TikTok</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/logos/twitter-round.svg')}}" alt="flag">
                    <p>Twitter</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/logos/tumblr-round.svg')}}" alt="flag">
                    <p>Tumblr</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
            ...
            <div class="card px-4 pb-5 sm:px-5">
              ...
              <div class="mt-5 space-y-4">
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/flags/australia-round.svg')}}" alt="flag">
                    <p>Australia</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/flags/brazil-round.svg')}}" alt="flag">
                    <p>Brazil</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/flags/china-round.svg')}}" alt="flag">
                    <p>China</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/flags/india-round.svg')}}" alt="flag">
                    <p>India</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/flags/italy-round.svg')}}" alt="flag">
                    <p>Italy</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/flags/japan-round.svg')}}" alt="flag">
                    <p>Japan</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/flags/russia-round.svg')}}" alt="flag">
                    <p>Russia</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <img class="size-6" src="{{asset('assets/images/flags/spain-round.svg')}}" alt="flag">
                    <p>Spain</p>
                  </div>
                  <div class="flex items-center space-x-2">
                    <p class="text-sm+ text-slate-800 dark:text-navy-100">
                  ...
                  <tbody>
                      ...
                      <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-9">
                            <img class="mask is-squircle" src="{{asset('assets/images/avatar/avatar-20.jpg')}}" alt="avatar">
                          </div>
                    ...
                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                      ...
                      <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-9">
                            <img class="mask is-squircle" src="{{asset('assets/images/avatar/avatar-18.jpg')}}" alt="avatar">
                          </div>
                    ...
                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                      ...
                      <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-9">
                            <img class="mask is-squircle" src="{{asset('assets/images/avatar/avatar-17.jpg')}}" alt="avatar">
                          </div>
                    ...
                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                      ...
                      <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-9">
                            <img class="mask is-squircle" src="{{asset('assets/images/avatar/avatar-16.jpg')}}" alt="avatar">
                          </div>
                    ...
                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                      ...
                      <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-9">
                            <img class="mask is-squircle" src="{{asset('assets/images/avatar/avatar-11.jpg')}}" alt="avatar">
                          </div>
                    ...
                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                      ...
                      <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-9">
                            <img class="mask is-squircle" src="{{asset('assets/images/avatar/avatar-1.jpg')}}" alt="avatar">
                          </div>
                    ...
                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                      ...
                      <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-9">
                            <img class="mask is-squircle" src="{{asset('assets/images/avatar/avatar-2.jpg')}}" alt="avatar">
                          </div>
                    ...
                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                      ...
                      <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-9">
                            <img class="mask is-squircle" src="{{asset('assets/images/avatar/avatar-5.jpg')}}" alt="avatar">
                          </div>
                    ...
                    <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                      ...
                      <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        <div class="flex items-center space-x-4">
                          <div class="avatar size-9">
                            <img class="mask is-squircle" src="{{asset('assets/images/avatar/avatar-7.jpg')}}" alt="avatar">
                          </div>
