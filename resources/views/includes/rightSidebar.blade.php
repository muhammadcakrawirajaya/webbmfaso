        ...
        <div class="mt-3 grid grid-cols-2 gap-3 px-3">
          <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
            <div class="flex items-center space-x-2">
              <img class="size-10" src="{{asset('assets/images/logos/bitcoin.svg')}}" alt="image">
              <div>
          ...
          <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
            <div class="flex items-center space-x-2">
              <img class="size-10" src="{{asset('assets/images/logos/solana.svg')}}" alt="image">
              <div>
                <h2 class="font-medium tracking-wide text-slate-700 dark:text-navy-100">
                  SOL
                </h2>
      ...
      <div class="mt-4">
        ...
        <div class="mt-3 space-y-3 px-2">
          <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
            ...
            <img src="{{asset('assets/images/object/object-18.jpg')}}" class="size-20 rounded-lg object-cover object-center"
              alt="image">
          </div>
          ...
          <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
            ...
            <img src="{{asset('assets/images/object/object-2.jpg')}}" class="size-20 rounded-lg object-cover object-center"
              alt="image">
          </div>
          ...
          <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
            ...
            <img src="{{asset('assets/images/object/object-1.jpg')}}" class="size-20 rounded-lg object-cover object-center"
              alt="image">
          </div>
        </div>
      </div>
    ...
    <div x-show="activeTab === 'tabProjects'" x-transition:enter="transition-all duration-500 easy-in-out"
      ...
      <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
        <div class="flex items-center space-x-3">
          <img class="size-10 rounded-lg object-cover object-center" src="{{asset('assets/images/illustrations/lms-ui.svg')}}"
            alt="image">
          <div>
      ...
      <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
        <div class="flex items-center space-x-3">
          <img class="size-10 rounded-lg object-cover object-center" src="{{asset('assets/images/illustrations/store-ui.svg')}}"
            alt="image">
          <div>
            <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
              Store Dashboard
      ...
      <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
        <div class="flex items-center space-x-3">
          <img class="size-10 rounded-lg object-cover object-center" src="{{asset('assets/images/illustrations/chat-ui.svg')}}"
            alt="image">
          <div>
            <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
              Chat Mobile App
      ...
      <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
        <div class="flex items-center space-x-3">
          <img class="size-10 rounded-lg object-cover object-center" src="{{asset('assets/images/illustrations/nft.svg')}}"
            alt="image">
          <div>
            <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
              NFT Marketplace App
