...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const alerts = Array.from(alertContainer.querySelectorAll(".custom-alert"));
    const maxAlerts = 3;

    alerts.forEach((alertBox, index) => {
        setTimeout(() => {
    ...
    function checkAlertLimit() {
        const currentAlerts = Array.from(
            alertContainer.querySelectorAll(".custom-alert")
        );
