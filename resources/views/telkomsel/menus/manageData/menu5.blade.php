        ...
        <main class="main-content w-full px-[var(--margin-x)] pb-8">
            ...
            @if (session('confirm_delete'))
                <div id="confirm-alert"
                    ...
                    <p>Data PIC masih digunakan di tabel order. Apakah Anda yakin ingin melanjutkan dan menghapusnya?
                    </p>
                    <div class="mt-4 space-x-3">
                        <a href="{{ route('pic.confirmDestroy', session('pic_id')) }}"
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex mr-4">
                            <div class="flex items-center" x-data="{ isInputActive: false }">
                                <form action="{{ route('manageDataMenu5.index') }}" method="GET">
                                    <label class="block">
                                        ...
                                        <div class="fixed inset-0 z-[100] flex flex-col items-center justify-center overflow-hidden px-4 py-6 sm:px-5"
                                            ...
                                            <div class="relative w-full max-w-lg origin-top rounded-lg bg-white transition-all duration-300 dark:bg-navy-700"
                                                ...
                                                <form id="addSOForm" method="POST"
                                                    action="{{ route('manageDataMenu5.store') }}"
                                                            ...
                                                            <div>
                                                                ...
                                                                <label class="mt-1.5 flex -space-x-px">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        placeholder="Masukkan Nama Feedback PIC"
                    ...
                    <div class="card mt-3">
                        @if ($pic->count())
                            <div class="is-scrollbar-hidden min-w-full overflow-x-auto">
                                <table class="w-full text-left">
                                    ...
                                    {{-- LIST --}}
                                    @isset($pic)
                                        @foreach ($pic as $index => $log)
                                            <tr class="border-y border-transparent">
                                                <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                                    {{ $pic->firstItem() + $index }}</td>
                                                <td
                                                                                ...
                                                                                <template x-teleport="#x-teleport-target">
                                                                                    <div id="editUserModal"
                                                                                        ...
                                                                                        <div class="relative max-w-md rounded-lg bg-white pt-10 pb-4 text-center transition-all duration-300 dark:bg-navy-700"
                                                                                            ...
                                                                                            <form
                                                                                                action="{{ route('manageDataMenu5.update', $log['id']) }}"
                                                                                                method="POST"
                                                                                                enctype="multipart/form-data">
                                                                                                @csrf
                                                                                                @method('PUT')
                                                                                                            ...
                                                                                                            <label
                                                                                                                ...
                                                                                                                <select
                                                                                                                    ...
                                                                                                                    @foreach ($status as $statu)
                                                                                                                        <option
                                                                                                                            value="{{ $statu->id }}"
                                                                                                                            {{ $statu->id == $log['id_status_kendala'] ? 'selected' : '' }}>
                                                                                                                            {{ $statu->status_kendala }}
                                                                                                                        </option>
                                                                                                                    @endforeach
                                                                                                                </select>
                                                                                        ...
                                                                                        <div class="relative max-w-md rounded-lg bg-white pt-10 pb-4 text-center transition-all duration-300 dark:bg-navy-700"
                                                                                            ...
                                                                                            <div class="space-x-3">
                                                                                                ...
                                                                                                <div class="inline-flex">
                                                                                                    <form
                                                                                                        action="{{ route('manageDataMenu5.destroy', $log['id']) }}"
                                                                                                        method="POST">
                                                                                                        @csrf
                                                                                                        @method('DELETE')
                                                                                                        <button
                        ...
                        @isset($pic)
                            <div
                                ...
                                <ol class="pagination flex justify-center mt-4">
                                    @if ($pic->lastPage() > 5)
                                        <nav role="navigation" aria-label="Pagination Navigation" class="pagination">
                                            ...
                                            {{-- Pagination Elements --}}
                                            @foreach (range(max(1, $pic->currentPage() - 2), min($pic->lastPage(), $pic->currentPage() + 2)) as $page)
                                                @if ($page == $pic->currentPage())
                                            ...
                                            @endif
                                            {{-- Last Page Link --}}
                                            @if ($pic->currentPage() < $pic->lastPage() - 2)
                                                <li class="rounded-r-lg bg-slate-150 dark:bg-navy-500">
                                                    <a href="{{ $pic->url($pic->lastPage()) }}"
                                                        class="pagination-link flex size-8 items-center justify-center rounded-lg text-slate-500 transition-colors hover:bg-slate-300 focus:bg-slate-300 active:bg-slate-300/80 dark:text-navy-200 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                            fill="currentColor" class="size-5">
                                                            <path fill-rule="evenodd"
                                    ...
                                    @else
                                        {{-- Default Pagination --}}
                                        @foreach (range(1, $pic->lastPage()) as $page)
                                            @if ($page == $pic->currentPage())
                                                <li class="active bg-slate-150 dark:bg-navy-500">
                                                    <a href="#"
                                                        class="flex h-8 min-w-[2rem] items-center justify-center rounded-lg bg-primary px-3 leading-tight text-white transition-colors hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">{{ $page }}</a>
                                ...
                                <div class="text-xs+">
                                    <b>{{ $pic->count() }}</b> of <b>{{ $pic->total() }}</b> entries
                                </div>
                            </div>
                        @endisset
                    </div>
