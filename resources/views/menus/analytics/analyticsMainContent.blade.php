                        ...
                        <div class="flex">
                            ...
                            <div>
                                <h5 class="font-semibold dark:text-white-light">
                                    New project created : <a href="javascript:;" class="text-success">[StarCode Kh
                                        Admin Template]</a>
                                </h5>
            ...
            <div class="panel h-full">
                <div class="-m-5 mb-5 flex items-start border-b border-[#e0e6ed] p-5 dark:border-[#1b2e4b]">
                    <div class="shrink-0 rounded-full ring-2 ring-white-light ltr:mr-4 rtl:ml-4 dark:ring-dark">
                        <img src="{{ asset('assets/images/profile-1.jpeg') }}" alt="image"
                ...
                <div>
                    ...
                    <div class="absolute bottom-0 -mx-5 flex w-full items-center justify-between p-5">
                        <div class="flex items-center">
                            <svg width="24" height="24" viewbox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                class="relative -top-0.5 inline h-5 w-5 text-info ltr:mr-1.5 rtl:ml-1.5">
                                <path
                        ...
                        <a href="javascript:;"
                            class="flex items-center rounded-md bg-success/30 px-1.5 py-1 text-xs text-success hover:shadow-[0_10px_20px_-10px] hover:shadow-success">Read
                            More
                            <svg width="24" height="24" viewbox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                class="h-4 w-4 ltr:ml-1.5 rtl:mr-1.5 rtl:rotate-180">
            ...
            <div class="panel h-full">
                    ...
                    <div class="flex">
                        <div class="media-aside align-self-start">
                            <div
                                ...
                                <img src="{{ asset('assets/images/g-8.png') }}" alt="image"
                                    class="h-10 w-10 rounded-full object-cover">
                            </div>
                        </div>
                        <div class="font-semibold">
                ...
                <div class="pb-8 text-center font-semibold">
                    ...
                    <div class="flex items-center justify-center gap-3 pb-8">
                        <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark"
                            src="{{ asset('assets/images/profile-1.jpeg') }}" alt="image">
                        <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark"
                            src="{{ asset('assets/images/profile-2.jpeg') }}" alt="image">
                        <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark"
                            src="{{ asset('assets/images/profile-3.jpeg') }}" alt="image">
                        <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark"
                            src="{{ asset('assets/images/profile-4.jpeg') }}" alt="image">
                    </div>
            ...
            <div class="panel h-full">
                <div
                    ...
                    <a href="javascript:;" class="flex font-semibold">
                        <div
                            class="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-secondary text-white ltr:mr-4 rtl:ml-4">
                            <span>FD</span>
                        </div>
                        <div>
                            <h6>Figma Design</h6>
                ...
                <div class="group">
                    ...
                    <div class="mb-2 flex items-center justify-between font-semibold">
                        <div class="flex items-center">
                            <svg width="24" height="24" viewbox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-success">
                                <path opacity="0.5"
                    ...
                    <div class="mb-5 h-2.5 rounded-full bg-dark-light p-0.5 dark:bg-dark-light/10">
                        <div class="h-full rounded-full bg-gradient-to-r from-[#1e9afe] to-[#60dfcd]"
                            style="width: 65%"></div>
                    </div>
                    <div class="flex items-end justify-between">
                        ...
                        <div
                            ...
                            <span
                                class="flex h-9 w-9 items-center justify-center rounded-full bg-[#bfc9d4] font-semibold text-white opacity-0 transition-all duration-300 group-hover:opacity-100 dark:bg-dark">+6</span>
                            <img class="h-9 w-9 rounded-full border-2 border-white object-cover transition-all duration-300 dark:border-dark"
                                src="{{ asset('assets/images/profile-6.jpeg') }}" alt="image">
                            <img class="h-9 w-9 rounded-full border-2 border-white object-cover transition-all duration-300 dark:border-dark"
                                src="{{ asset('assets/images/profile-7.jpeg') }}" alt="image">
                            <img class="h-9 w-9 rounded-full border-2 border-white object-cover transition-all duration-300 dark:border-dark"
                                src="{{ asset('assets/images/profile-8.jpeg') }}" alt="image">
                        </div>
                    </div>
                </div>
            </div>
